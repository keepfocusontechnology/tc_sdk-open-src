...
/**
 * author: Soulwolf Created on 2015/9/17 1:31.
 * email : Ching.Soulwolf@gmail.com
 */
public class Platform {

    static final String TAG = Platform.class.getSimpleName();
    ...
    //天赐平台分配的游戏id
    public static final String TIANCI_SERVER_ID = "TIANCI_SERVER_ID";
    //天赐平台分配的渠道ID
    ...
    private void parserMetaData(Context context) {
        try {
            ...
            mDeviceId = ((TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE))
                    .getDeviceId();
            mUserAgent = Build.MODEL;
            mGameId = appInfo.metaData.getInt(TIANCI_GAME_ID) ;
            mServerId = appInfo.metaData.getInt(TIANCI_SERVER_ID) ;
            mChannelId = appInfo.metaData.getInt(TIANCI_CHANNEL_ID) ;
            mDeviceType = 1;

            SharedPreferencesUtils.setParam(context, TIANCI_DEVICE_ID, mDeviceId);
            SharedPreferencesUtils.setParam(context, TIANCI_GAME_ID, mGameId);
            SharedPreferencesUtils.setParam(context, TIANCI_SERVER_ID, mServerId);
            SharedPreferencesUtils.setParam(context, TIANCI_CHANNEL_ID, mChannelId);
            SharedPreferencesUtils.setParam(context, TIANCI_USER_AGENT, mUserAgent);
            SharedPreferencesUtils.setParam(context, TIANCI_DEVICE_TYPE, mDeviceType);
            TCLogUtils.d("清单文件中取出的初始化内容:mGameId="+mGameId+",mSeverId="+mServerId+"," +
